...
public class HomePage extends javax.swing.JFrame {
    ...
    if ("Admin".equals(role)) user.setVisible(false);
...
public HomePage(String role) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(homie, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 180, 660, 240));
    ...
    for (JButton btn : others) btn.setBackground(new Color(214, 255, 132)); 
    }
}
